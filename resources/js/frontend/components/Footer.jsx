        ...
        <footer className="w-full bg-[#0c0f24] text-white border-t border-white/10">
            <div className="w-full py-20 px-margin-desktop max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
                <div className="col-span-1">
                    ...
                    <div className="flex gap-3">
                        {settings.social_facebook && (
                            <a className="w-10 h-10 rounded border border-white/20 flex items-center justify-center text-[#8d9aa1] hover:bg-tertiary/10 hover:border-tertiary hover:text-tertiary transition-all" href={settings.social_facebook} aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                        ...
                        {settings.social_linkedin && (
                            <a className="w-10 h-10 rounded border border-white/20 flex items-center justify-center text-[#8d9aa1] hover:bg-tertiary/10 hover:border-tertiary hover:text-tertiary transition-all" href={settings.social_linkedin} aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        {settings.social_twitter && (
                            <a className="w-10 h-10 rounded border border-white/20 flex items-center justify-center text-[#8d9aa1] hover:bg-tertiary/10 hover:border-tertiary hover:text-tertiary transition-all" href={settings.social_twitter} aria-label="Twitter / X" target="_blank" rel="noopener noreferrer">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        {settings.social_instagram && (
                            <a className="w-10 h-10 rounded border border-white/20 flex items-center justify-center text-[#8d9aa1] hover:bg-tertiary/10 hover:border-tertiary hover:text-tertiary transition-all" href={settings.social_instagram} aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        {settings.social_youtube && (
                            <a className="w-10 h-10 rounded border border-white/20 flex items-center justify-center text-[#8d9aa1] hover:bg-tertiary/10 hover:border-tertiary hover:text-tertiary transition-all" href={settings.social_youtube} aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-4 text-[#8d9aa1] font-mono text-xs">
                        <div>
                            <span className="text-white font-bold text-[10px] uppercase tracking-wider block mb-1">Corporate Office</span>
                            <div 
                        ...
                        <div>
                            <span className="text-white font-bold text-[10px] uppercase tracking-wider block mb-1">Registered Office</span>
                            <div 
                                className="leading-relaxed opacity-95 rich-text text-justify"
            ...
            <div className="w-full border-t border-white/10 py-8 px-margin-desktop max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-6">
                    <span className="flex items-center gap-2 text-[#8d9aa1] text-[10px] font-bold uppercase tracking-widest">
