...
Route::get('/admin-portal/login', [AuthController::class, 'showLogin'])->name('login');
Route::post('/admin-portal/login', [AuthController::class, 'login']);
Route::match(['get', 'post'], '/admin-portal/logout', [AuthController::class, 'logout'])->name('logout');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/admin-portal/{any}', function () {
        return view('admin');
    })->where('any', '.*');
});
